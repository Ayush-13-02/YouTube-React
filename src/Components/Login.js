...
function Login({ checklogin,setChecklogin,handlelogpass }) {
    ...
    return (
        <>
            <div className="relative w-[90%] flex flex-col justify-center items-center aspect-vedio">
                <div className="md:border md:border-gray-300 bg-white md:shadow-lg shadow-none rounded p-10" >
                    ...
                    <form className="my-8">
                        <div className="relative mb-2">
                            <input id="email" className="w-full text-xl rounded px-3 border border-gray-500 pt-5 pb-2 focus:border-blue-700 focus:ring-1 focus:ring-blue-700 focus:outline-none input active:outline-none" value={checklogin} onChange={event => setChecklogin(event.target.value)} type="email" autoFocus />
                            <label htmlFor="email" className="label absolute mt-2 ml-3 leading-tighter text-gray-600 text-lg cursor-text" style={checklogin.length!==0 ?  uemailstyle  : null}>Email or phone</label>
                        </div>
                        <div className="space-y-9">
                            ...
                            <div className="text-lg flex justify-between items-center">
                                ...
                                <button className="py-2 px-6 rounded text-white btn bg-blue-500 hover:bg-blue-600" onClick={check}>Next</button>
                            </div>
                        </div>
                    </form>
                </div>
